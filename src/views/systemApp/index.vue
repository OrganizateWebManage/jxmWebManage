<template>
	<section>
       ...
       <template slot-scope="scope">
		...
		<el-dialog title="类型更改(0:系统应用 1：复兰应用 2：第三方应用)" :visible.sync="typeVisible" style="width:900px">
...
import {searchAppByCondition,deleteApk,setOrder,updateApkByType,loadApk} from '@/api/searchmarket'
